...
### Residency
Michigan law states that the same address must be used for voter registration and driver's license purposes. If the registration address is different from your driver's license or personal identification card issued by the state of Michigan, the Secretary of State will automatically change your driver's license or personal ID card address to match the residence address entered on this form. If a change is made, the Secretary of State will mail you an address update sticker for your driver's license or personal ID card.

### Outside of the US
If you are living outside the U.S., you may send a [Federal Postcard Application](https://www.fvap.gov/) to register to vote. This application is distributed through U.S. embassies and military bases. It also serves as a way to request an absentee ballot.

## Verify Your Voter Registration
You can check your voter registration status through the [Michigan Voter Information Center](https://mvic.sos.state.mi.us/).
